...
#define BOARD_INITSILEX2401SHIELD_KFETON_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITSILEX2401SHIELD_KFETON_GPIO_PIN_MASK (1U << 4U) /*!<@brief GPIO pin mask */
#define BOARD_INITSILEX2401SHIELD_KFETON_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSILEX2401SHIELD_KFETON_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_INITSILEX2401SHIELD_KFETON_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                                  /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITSILEX2401SHIELD_PWRON_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITSILEX2401SHIELD_PWRON_GPIO_PIN_MASK (1U << 7U) /*!<@brief GPIO pin mask */
#define BOARD_INITSILEX2401SHIELD_PWRON_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSILEX2401SHIELD_PWRON_PIN 7U                   /*!<@brief PORT pin number */
#define BOARD_INITSILEX2401SHIELD_PWRON_PIN_MASK (1U << 7U)      /*!<@brief PORT pin mask */
                                                                 /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITSILEX2401SHIELD_IRQ_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITSILEX2401SHIELD_IRQ_GPIO_PIN_MASK (1U << 15U) /*!<@brief GPIO pin mask */
#define BOARD_INITSILEX2401SHIELD_IRQ_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSILEX2401SHIELD_IRQ_PIN 15U                   /*!<@brief PORT pin number */
#define BOARD_INITSILEX2401SHIELD_IRQ_PIN_MASK (1U << 15U)      /*!<@brief PORT pin mask */
                                                                /* @} */
